package com.example.openrestaurant.services
                ...
                ?.addOnFailureListener { ex ->
                    if ((ex as ApiException).statusCode == LocationSettingsStatusCodes.RESOLUTION_REQUIRED) {
                        try {
                            ...
                            resolvableApiException.startResolutionForResult(mContext,
                        ...
                        if (ex.statusCode == LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE) {
                            val errorMessage =
                                "Location Settings are inadequate and cannot be fixed here. Fix in the settings"
